...
func init() {
	...
	RootCmd.Flags().Uint32VarP(&FlagNodes, NodesOptionStr, "N", 1, "Number of nodes requested")
	...
	RootCmd.Flags().Uint32VarP(&FlagNtasks, NtasksOptionStr, "n", 1, "Total number of tasks")
