...
func outputReservationJson(reservations []*protos.ReservationInfo) error {
	fmt.Println(util.FmtJson.FormatReply(&protos.QueryReservationInfoReply{
		ReservationInfoList: reservations,
	}))
	return nil
}
