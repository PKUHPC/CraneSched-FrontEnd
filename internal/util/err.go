...
var errMsgMap = map[protos.ErrCode]string{
	...
	protos.ErrCode_ERR_MAX_JOB_COUNT_PER_USER:          "The number of tasks for the current user has reached the limit",
	protos.ErrCode_ERR_MAX_JOB_COUNT_PER_ACCOUNT:       "The number of tasks for the current account has reached the limit",
	protos.ErrCode_ERR_MAX_JOB_COUNT_PER_QOS:           "The number of tasks has reached the limit",
	protos.ErrCode_ERR_TRES_PER_TASK_BEYOND:            "The tres of tasks has reached the limit",
	protos.ErrCode_ERR_MAX_TRES_PER_USER_BEYOND:        "The tres of tasks for the current user has reached the limit",
	protos.ErrCode_ERR_MAX_TRES_PER_ACCOUNT_BEYOND:     "The tres of tasks for the current account has reached the limit",
