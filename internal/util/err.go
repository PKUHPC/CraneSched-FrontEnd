...
var errMsgMap = map[protos.ErrCode]string{
	...
	protos.ErrCode_ERR_ALLOWEDLIST_MISSING:    "The account does not have permission to run jobs in this partition. Please contact the administrator to add it to the allowed list",
	protos.ErrCode_ERR_DENYLIST_HIT:           "The account has been denied access to this partition. Please contact the security administrator if access is required",
}
