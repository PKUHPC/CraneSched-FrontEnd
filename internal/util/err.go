...
var errMsgMap = map[protos.ErrCode]string{
	...
	protos.ErrCode_ERR_USER_DUPLICATE_ACCOUNT:  "The user already exists in this account",
	protos.ErrCode_ERR_USER_ALLOWED_ACCOUNT:    "The user is not allowed to access account",
	...
	protos.ErrCode_ERR_INVALID_PARENTACCOUNT:   "The parent account of the entered account does not exist",
	protos.ErrCode_ERR_DUPLICATE_ACCOUNT:       "The account already exists in the crane",
	protos.ErrCode_ERR_DELETE_ACCOUNT:          "The account has child account or users, unable to delete.",
	...
	protos.ErrCode_ERR_ALLOWED_PARTITION:       "The entered account or user does not include this partition",
	protos.ErrCode_ERR_PARENT_ALLOWED_PARTITION: "Parent account does not include the partition",
	protos.ErrCode_ERR_DUPLICATE_PARTITION:     "The partition already exists in the account or user",
	...
	protos.ErrCode_ERR_DB_DUPLICATE_QOS:        "Qos already exists in the crane",
	protos.ErrCode_ERR_DELETE_QOS:              "QoS is still being used by accounts or users, unable to delete",
	protos.ErrCode_ERR_CONVERT_TO_INTERGER:     "Failed to convert value to integer",
	protos.ErrCode_ERR_TIME_LIMIT:              "Invalid time limit value",
	protos.ErrCode_ERR_ALLOWED_QOS:             "The entered account or user does not include this qos",
	protos.ErrCode_ERR_DUPLICATE_QOS:           "The Qos already exists in the account or user",
	protos.ErrCode_ERR_PARENT_ALLOWED_QOS:      "Parent account does not include the qos",
	...
	protos.ErrCode_ERR_ALLOWED_DEFAULT_QOS:     "The entered default_qos is not allowed",
	...
	protos.ErrCode_ERR_IS_DEFAULT_QOS:          "The QoS is the default QoS for the current user/Account and cannot be modified. Ignoring this constraint with forced operation, the default QoS is randomly replaced with one of the items in the new QoS list",
